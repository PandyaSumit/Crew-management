...
export const projects: Project[] = [
  {
    id: 'proj-1',
    name: 'Q1 2026 Crew Evaluation Program',
    description: 'Comprehensive quarterly performance assessment for all cabin crew and pursers',
    status: 'active',
    plansCount: 5,
    completedPlans: 2,
  ...
  },
  {
    ...
    description: 'Annual safety procedure compliance review across all crew categories',
    status: 'active',
    plansCount: 3,
    completedPlans: 1,
  ...
  },
  {
    ...
    description: 'Structured evaluation program for crew members joining in 2026',
    status: 'draft',
    plansCount: 4,
    completedPlans: 0,
  ...
  {
    id: 'proj-4',
    name: '2025 Year-End Evaluations',
    description: 'Final performance review cycle for fiscal year 2025',
    status: 'completed',
    plansCount: 6,
    completedPlans: 6,
...
export const plans: Plan[] = [
  {
    id: 'plan-1',
    projectId: 'proj-1',
    name: 'February Flight Assessments',
    description: 'In-flight evaluations for all crew on February scheduled routes',
    status: 'in-progress',
    updatedAt: '2026-02-19',
    tasks: [
      { id: 't1', title: 'Evaluate Ahmed Hassan – SM 302', status: 'done', assignee: 'Supervisor A', priority: 'high' },
      { id: 't2', title: 'Evaluate Sara Mohamed – SM 305', status: 'in-progress', assignee: 'Supervisor A', priority: 'high' },
      { id: 't3', title: 'Evaluate Omar Khaled – SM 102', status: 'todo', assignee: 'Supervisor B', priority: 'medium' },
      { id: 't4', title: 'Evaluate Fatma Ali – SM 412', status: 'done', assignee: 'Supervisor B', priority: 'high' },
      { id: 't5', title: 'Evaluate Youssef Ibrahim – SM 510', status: 'todo', assignee: 'Supervisor A', priority: 'medium' },
    ],
  },
  {
    id: 'plan-2',
    projectId: 'proj-1',
    name: 'Purser Leadership Review',
    description: 'Assessment of leadership and cabin management skills for all pursers',
    status: 'completed',
    updatedAt: '2026-02-10',
    tasks: [
      { id: 't6', title: 'Review Fatma Ali – Leadership Competency', status: 'done', assignee: 'Manager', priority: 'high' },
      { id: 't7', title: 'Review Nour El-Din – CRM Assessment', status: 'done', assignee: 'Manager', priority: 'high' },
    ],
  },
  {
    id: 'plan-3',
    projectId: 'proj-1',
    name: 'March Pre-Season Readiness',
    description: 'Pre-peak season readiness checks and crew briefings',
    status: 'draft',
    updatedAt: '2026-02-14',
    tasks: [
      { id: 't8', title: 'Schedule pre-season briefings', status: 'todo', assignee: 'Coordinator', priority: 'medium' },
      { id: 't9', title: 'Update evaluation criteria for spring schedule', status: 'todo', assignee: 'Manager', priority: 'low' },
      { id: 't10', title: 'Assign evaluators to flight blocks', status: 'todo', assignee: 'Coordinator', priority: 'high' },
    ],
  },
  {
    id: 'plan-4',
    projectId: 'proj-1',
    name: 'Cross-Route Performance Benchmarking',
    description: 'Compare crew performance across long-haul and short-haul routes',
    status: 'draft',
    updatedAt: '2026-02-12',
    tasks: [
      { id: 't11', title: 'Collect data from long-haul evaluations', status: 'todo', assignee: 'Analyst', priority: 'medium' },
      { id: 't12', title: 'Compare short-haul results', status: 'todo', assignee: 'Analyst', priority: 'medium' },
      { id: 't13', title: 'Generate comparison report', status: 'todo', assignee: 'Analyst', priority: 'low' },
    ],
  },
  {
    id: 'plan-5',
    projectId: 'proj-1',
    name: 'Q1 Final Report',
    description: 'Consolidated report summarizing all Q1 evaluation outcomes',
    status: 'draft',
    updatedAt: '2026-02-01',
    tasks: [
      { id: 't14', title: 'Compile all evaluation scores', status: 'todo', assignee: 'Manager', priority: 'high' },
      { id: 't15', title: 'Draft executive summary', status: 'todo', assignee: 'Manager', priority: 'medium' },
      { id: 't16', title: 'Present findings to leadership', status: 'todo', assignee: 'Director', priority: 'high' },
    ],
  },
  {
    id: 'plan-6',
    projectId: 'proj-2',
    name: 'Emergency Procedures Compliance',
    description: 'Verify all crew compliance with updated emergency procedures',
    status: 'completed',
    updatedAt: '2026-02-16',
    tasks: [
      { id: 't17', title: 'Audit emergency equipment checks', status: 'done', assignee: 'Safety Officer', priority: 'high' },
      { id: 't18', title: 'Review door arming compliance', status: 'done', assignee: 'Safety Officer', priority: 'high' },
      { id: 't19', title: 'Validate evacuation drill records', status: 'done', assignee: 'Safety Officer', priority: 'high' },
    ],
  },
  {
    id: 'plan-7',
    projectId: 'proj-2',
    name: 'SAFA Protocol Review',
    description: 'SAFA ramp check protocol adherence assessment',
    status: 'in-progress',
    updatedAt: '2026-02-17',
    tasks: [
      { id: 't20', title: 'Review SAFA documentation with crew', status: 'done', assignee: 'Supervisor A', priority: 'high' },
      { id: 't21', title: 'Simulate SAFA ramp check scenarios', status: 'in-progress', assignee: 'Supervisor B', priority: 'high' },
      { id: 't22', title: 'Update crew on regulatory changes', status: 'todo', assignee: 'Safety Officer', priority: 'medium' },
    ],
  },
  {
    id: 'plan-8',
    projectId: 'proj-2',
    name: 'Security Procedure Audit',
    description: 'Pre-boarding and in-flight security procedure compliance review',
    status: 'draft',
    updatedAt: '2026-02-10',
    tasks: [
      { id: 't23', title: 'Audit pre-boarding security checks', status: 'todo', assignee: 'Security Lead', priority: 'high' },
      { id: 't24', title: 'Review passenger screening procedures', status: 'todo', assignee: 'Security Lead', priority: 'medium' },
    ],
  },
];
